...
| 우선 | 항목 | 주기 | 자동화 |
|---|---|---|---|
| 🔴 1 | CDN 의존성 SRI + 버전 핀 점검 | 1회 + 분기 | 부분 |
| 🔴 2 | Capacitor / Gradle / AGP 보안 패치 | 월 | Dependabot |
| 🔴 3 | Play Console 타겟 SDK / 데이터 안전 / 개인정보처리방침 | 연 (필수) | X |
| 🟡 4 | 에러 모니터링 도입 (window.onerror → Sentry) | 1회 | - |
| 🟡 5 | 안드로이드 키스토어 백업 정책 | 1회 + 분기 점검 | X |
| 🟡 6 | GitHub Dependabot 활성화 | 1회 | O |
| 🟢 7 | 캐시버스터 `?v=N` git history 일치 검사 | push마다 | 권장 |
| 🟢 8 | iOS / Android 실기 회귀 테스트 | 분기 | X |
| 🟢 9 | OSS 라이선스 고지 페이지 | 1회 + 연 1회 | X |
